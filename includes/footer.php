            ...
            <div class="container py-5">
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>123 Rue, Ariana, Tunis</p>
                        <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+216 71 234 567</p>
                        <p class="mb-2"><i class="fa fa-envelope me-3"></i>contact@makaan.com</p>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <a class="btn btn-link text-white-50" href="about.php">À Propos</a>
                        <a class="btn btn-link text-white-50" href="contact.php">Contactez-nous</a>
                        <a class="btn btn-link text-white-50" href="property-list.php">Nos Propriétés</a>
